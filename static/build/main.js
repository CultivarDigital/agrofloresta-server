...
var Database = /** @class */ (function () {
    ...
    Database.prototype.saveProfile = function (item) {
        ...
        return this.http.put(this.baseUrl + 'users/' + item._id, item, { headers: this.httpHeaders() }).toPromise().then(function (user) {
            ...
            _this.currentUser.email = user.email;
            _this.currentUser.bio = user.bio;
            _this.currentUser.phone = user.phone;
            _this.currentUser.address = user.address;
            _this.currentUser.picture = user.picture;
            _this.currentUser.profileCompleted = user.profileCompleted;
    ...
    Database.prototype.login = function (credentials) {
        var _this = this;
        return this.http.post(this.baseUrl + "users/login", credentials).toPromise().then(function (res) {
            if (res && res._id) {
                _this.storage.set('currentUser', res);
