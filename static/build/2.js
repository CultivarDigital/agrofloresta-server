...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TopicFormPageModule", function() { return TopicFormPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(42);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__topic_form__ = __webpack_require__(690);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_ngx_quill__ = __webpack_require__(491);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_components_module__ = __webpack_require__(492);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_ngx_chips__ = __webpack_require__(519);
...
var TopicFormPageModule = /** @class */ (function () {
    function TopicFormPageModule() {
    }
    TopicFormPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__topic_form__["a" /* TopicFormPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__topic_form__["a" /* TopicFormPage */]),
    ...
    return TopicFormPageModule;
}());

//# sourceMappingURL=topic-form.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return TopicFormPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
...
var TopicFormPage = /** @class */ (function () {
    function TopicFormPage(navCtrl, toastCtrl, formBuilder, database, api, utils, params) {
        var _this = this;
        this.navCtrl = navCtrl;
        ...
        this.database.query('topics').then(function (res) {
            if (res) {
                res.forEach(function (a) {
                    _this.autocompleteTags = _this.autocompleteTags.concat(a.tags);
                });
                _this.autocompleteTags = _this.autocompleteTags.map(function (v) {
                    return (typeof v == 'string') ? v : v['value'];
                }).filter(function (v, i, a) { return a.indexOf(v) === i; }).sort();
            }
        });
    }
    TopicFormPage.prototype.edit = function (id) {
        var _this = this;
        this.database.get('topics', id).then(function (item) {
            if (item) {
                _this.topic = item;
    ...
    TopicFormPage.prototype.delete = function (topic) {
        var _this = this;
        this.utils.showConfirm(function () {
            _this.database.remove('topics', topic).then(function (res) {
                _this.navCtrl.setRoot('ForumPage');
            });
        });
    };
    TopicFormPage.prototype.save = function () {
        var _this = this;
        if (!this.form.valid) {
            return;
        }
        this.utils.showConfirm(function () {
            ...
            _this.database.save("topics", _this.form.value).then(function (res) {
                if (res) {
                    if (!_this.form.controls._id.value) {
                        _this.database.save("comments", { topic: res._id, message: _this.form.controls.content.value });
                    }
                    _this.navCtrl.setRoot('ForumPage');
                    _this.navCtrl.push('TopicPage', { id: res._id });
                }
            });
        });
    };
    TopicFormPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-topic-form',template:/*ion-inline-start:"/home/diego/dev/agrofloresta/src/pages/topic-form/topic-form.html"*/'<ion-header>\n\n  <ion-navbar>\n    <ion-title>Tópico de discussão</ion-title>\n    <ion-buttons end>\n      <button ion-button icon-only *ngIf="this.api.loading">\n	      <ion-spinner></ion-spinner>\n	    </button>\n      <button ion-button icon-only (click)="delete(form.value)" *ngIf="form.controls._id.value">\n        <ion-icon name="trash"></ion-icon>\n      </button>\n      <button ion-button icon-only (click)="save()" [disabled]="!isReadyToSave" strong>\n        <ion-icon name="checkmark"></ion-icon>\n      </button>\n    </ion-buttons>\n  </ion-navbar>\n\n</ion-header>\n<ion-content padding>\n  <form *ngIf="form" [formGroup]="form">\n    <ion-item>\n      <ion-label stacked>Assunto do tópico*:</ion-label>\n      <ion-input type="text" formControlName="title"></ion-input>\n    </ion-item>\n    <ion-label stacked>Palavras chave:</ion-label>\n    <tag-input formControlName="tags" [placeholder]="\'+ Palavra chave\'" [secondaryPlaceholder]="\'+ Palavra chave\'" [separatorKeyCodes]="[9]">\n      <tag-input-dropdown [focusFirstElement]="true" [autocompleteItems]="autocompleteTags" ></tag-input-dropdown>\n    </tag-input>\n    <ion-item *ngIf="!form.controls._id.value">\n      <ion-label stacked>Mensagem*:</ion-label>\n      <ion-textarea formControlName="content"></ion-textarea>\n    </ion-item>\n  </form>\n  <br>\n</ion-content>  '/*ion-inline-end:"/home/diego/dev/agrofloresta/src/pages/topic-form/topic-form.html"*/,
        }),
