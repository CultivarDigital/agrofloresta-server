...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "GuideFormPageModule", function() { return GuideFormPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(42);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__guide_form__ = __webpack_require__(667);
...
var GuideFormPageModule = /** @class */ (function () {
    function GuideFormPageModule() {
    }
    GuideFormPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__guide_form__["a" /* GuideFormPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__guide_form__["a" /* GuideFormPage */]),
    ...
    return GuideFormPageModule;
}());

//# sourceMappingURL=guide-form.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return GuideFormPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
...
var GuideFormPage = /** @class */ (function () {
    function GuideFormPage(navCtrl, toastCtrl, formBuilder, database, api, utils, params) {
        var _this = this;
        this.navCtrl = navCtrl;
        ...
        this.database.query('posts').then(function (res) {
            if (res) {
    ...
    GuideFormPage.prototype.edit = function (id) {
        var _this = this;
        this.database.get('guides', id).then(function (item) {
            if (item) {
                _this.guide = item;
    ...
    GuideFormPage.prototype.delete = function (guide) {
        var _this = this;
        this.utils.showConfirm(function () {
            _this.database.remove('guides', guide).then(function (res) {
                _this.navCtrl.setRoot('GuidesPage');
            });
        });
    };
    GuideFormPage.prototype.save = function () {
        var _this = this;
        if (!this.form.valid) {
            return;
        }
        this.utils.showConfirm(function () {
            ...
            _this.database.save('guides', _this.form.value).then(function (res) {
                _this.navCtrl.setRoot('GuidesPage');
                _this.navCtrl.push('GuidePage', { id: res.id });
            });
        });
    };
    __decorate([
...
//# sourceMappingURL=guide-form.js.map
